  ...
  return (
    <nav className={style.navbar}>
      ...
      <div className={style.darkmodeContainer}>
        <label
          htmlFor="darkmode"
          className={`${style.darkmode} ${style[dark]}`}
        ></label>
        <input
          type="checkbox"
          id="darkmode"
          ...
          onInput={handleDark}
        />
        <button className={style.btnPrint} onClick={handleClickPrint}>
          <img className={style.printLogo} src={print} alt={"Imprimir"} />
        </button>
      {/*   <div className={style.linkContainer}>
          <Link to="/en_US" className={style.link}>
            Eng
          </Link>
          <Link to="/es_AR" className={style.link}>
            Esp
          </Link>
        </div> */}
      </div>
